      ...
      <ScrollView>
        <View>
          <View style={{marginTop : 60, alignItems : 'center', justifyContent:'center'}}>
            ...
            {/* Text Field Fullname */}
            <InputTextFields title="Fullname" style={{marginTop : 32, marginBottom : 8}}></InputTextFields>
            {/* Text Field Password */}
            ...
            <Text  style={[styles.text, {fontSize : 14, color : "#ABB4BD", textAlign : "center", marginTop:24}]}>
              have an account?
              <Text style={[styles.text, styles.link]} onPress={() => navigation.navigate('LoginScreen')} >
                Login Now
              </Text>
            </Text>
